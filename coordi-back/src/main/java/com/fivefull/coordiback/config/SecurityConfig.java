package com.fivefull.coordiback.config;

import com.fivefull.coordiback.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/api/member/signup", "/api/member/login",
                                ...
                                "/api/ai-fashion","/api/ai-fashion2","/api/member/reset-password").permitAll()
